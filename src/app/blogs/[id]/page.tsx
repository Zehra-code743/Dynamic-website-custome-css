...
const data: Data[] = [
  ...
  },
  {
    ...
    content:
      "Maximize your fragrances longevity and impact with expert tips. Learn about the best application techniques such as pulse points and layering. Understand the role of skin type and climate in scent performance. Get advice on how to store your fragrances to keep them fresh and potent.",
